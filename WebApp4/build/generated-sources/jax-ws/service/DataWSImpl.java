 ...
 * 
 */
@WebService(name = "DataWSImpl", targetNamespace = "http://service/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface DataWSImpl {
    ...
    @Action(input = "http://service/DataWSImpl/getDataRequest", output = "http://service/DataWSImpl/getDataResponse")
    public Data getData();
